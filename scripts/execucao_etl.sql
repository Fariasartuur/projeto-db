...
-- SUBSTITUA o caminho abaixo pelo caminho real do seu arquivo de CNES.
DECLARE @CaminhoArquivoCNES VARCHAR(500) = 'C:\dataset\cnes_estabelecimentos.csv';

-- Chama a procedure mestra para o ETL de CID
EXEC sp_ETL_CNES @caminhoArquivo = @CaminhoArquivoCNES;
GO
